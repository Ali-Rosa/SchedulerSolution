...
public class EnglishUsLocalizer : BaseSchedulerLocalizer
{
    public override string Locale => "en-US";
    protected override CultureInfo Culture => new("en-US");
    protected override string DateFormat => "MM-dd-yyyy";
    protected override string TimeFormat => "h:mm tt";

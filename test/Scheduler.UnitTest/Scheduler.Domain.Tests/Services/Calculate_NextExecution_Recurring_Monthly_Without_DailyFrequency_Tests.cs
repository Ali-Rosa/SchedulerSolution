...
public class Calculate_NextExecution_Recurring_Monthly_Without_DailyFrequency_Tests
{
    ...
    public void Calculate_NextExecution_Recurring_Monthly_Without_DailyFrequency_RelativeDay_Weekday_ReturnsExpectedDescription()
    {
        ...
        var config = ScheduleConfigurationBuilder.RecurringMonthly()
            .With_Locale("en-US")
            .With_RecursEvery(1)
            .With_MonthlyRelativeDay(MonthlyRelativeOrdinal.First, MonthlyRelativeDayType.Weekday)
            .Build();
    ...
    public void Calculate_NextExecution_Recurring_Monthly_Without_DailyFrequency_RelativeDay_Day_ReturnsExpectedDescription()
    {
        ...
        var config = ScheduleConfigurationBuilder.RecurringMonthly()
            .With_Locale("en-US")
            .With_RecursEvery(2)
            .With_MonthlyRelativeDay(MonthlyRelativeOrdinal.Last, MonthlyRelativeDayType.Day)
            .Build();
    ...
    public void Calculate_NextExecution_Recurring_Monthly_Without_DailyFrequency_RelativeDay_Daily_ReturnsExpectedDescription()
    {
        ...
        var config = ScheduleConfigurationBuilder.RecurringMonthly()
            .With_Locale("en-US")
            .With_RecursEvery(1)
            .With_MonthlyRelativeDay(MonthlyRelativeOrdinal.Third, MonthlyRelativeDayType.Day)
            .Build();
    ...
    public void Calculate_NextExecution_Recurring_Monthly_Without_DailyFrequency_RelativeDay_SpecificDayOfWeek_ReturnsExpectedDescription()
    {
        ...
        var config = ScheduleConfigurationBuilder.RecurringMonthly()
            .With_Locale("en-US")
            .With_RecursEvery(1)
            .With_MonthlyRelativeDay(MonthlyRelativeOrdinal.Fourth, MonthlyRelativeDayType.Thursday)
            .Build();
    ...
    public void CalculateNextExecution_RecurringMonthly_AllOrdinals_ReturnsValidExecution(MonthlyRelativeOrdinal ordinal)
    {
        ...
        var config = ScheduleConfigurationBuilder.RecurringMonthly()
            .With_Locale("en-US")
            .With_RecursEvery(1)
            .With_MonthlyRelativeDay(ordinal, MonthlyRelativeDayType.Weekday)
            .Build();
    ...
    public void CalculateNextExecution_RecurringMonthly_AllDayTypesDayOfWeekValues_ReturnsExpectedResults()
    {
        ...
        var config = ScheduleConfigurationBuilder.RecurringMonthly()
            .With_Locale("en-US")
            .With_RecursEvery(1)
            .With_MonthlyRelativeDay(MonthlyRelativeOrdinal.Second, MonthlyRelativeDayType.Friday)
            .Build();
    ...
    public void Calculate_NextExecution_Recurring_Monthly_Without_DailyFrequency_FormatDayType_InvalidEnum_ReturnsError()
    {
        ...
        var config = ScheduleConfigurationBuilder.RecurringMonthly()
            .With_Locale("en-US")
            .With_RecursEvery(1)
            .With_MonthlyRelativeDay(MonthlyRelativeOrdinal.First, (MonthlyRelativeDayType)66)
            .Build();
    ...
    public void Calculate_NextExecution_Recurring_Monthly_Without_DailyFrequency_InvalidRelativeOrdinal_ReturnsError()
    {
        ...
        var config = ScheduleConfigurationBuilder.RecurringMonthly()
            .With_Locale("en-US")
            .With_RecursEvery(1)
            .With_MonthlyRelativeDay((MonthlyRelativeOrdinal)85, MonthlyRelativeDayType.Monday) // 85 no existe en el enum SchedulerMonthlyRelativeOrdinal
            .Build();
        ...
        string expectedHoursCsv)
    {
        ...
        var config = ScheduleConfigurationBuilder.RecurringMonthly()
            ...
            .With_DailyFrequency_OccursEvery(TimeIntervalUnit.Hours, 2, new TimeOnly(8, 0), new TimeOnly(10, 0))

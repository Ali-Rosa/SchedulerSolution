...
//[Fact]
//public void CalculateNextExecution_GeneralsValidations_LimitsStartDateEqualToLimitsEndDate_ShouldPassValidation()
//{
//    var currentDate = new DateTimeOffset(2026, 5, 15, 10, 0, 0, TimeSpan.Zero);
//    var Limit = new DateTimeOffset(2026, 5, 15, 10, 0, 0, TimeSpan.Zero);

//    SchedulerConfiguration config = new()
//    {
//        Enabled = true,
//        Type = SchedulerType.Once,
//        //ExecutionDateTimeLocal = Limit,
//        Occurs = OccursType.Daily,
//        RecursEvery = 1,
//        LimitsStartDateLocal = Limit,
//        LimitsEndDateLocal = Limit,
...
//    result.NextExecutionTime.ShouldBe(Limit);
...
public class CalculateNextExecution_OnceDaily_Tests
{
    ...
    [Fact]
    public void CalculateNextExecution_OnceDaily_WithoutExecutionDateTimeLocal_ShouldUseCurrentDate()
    {
        // Arrange
        SchedulerConfiguration config = new()
        {
    ...
    [Fact]
    public void CalculateNextExecution_OnceDaily_WithExecutionDateTimeLocal_ShouldUseExecutionDateTimeLocal()
    {
        // Arrange
    ...
    {
        // Arrange
        var executionDateTime = new DateTimeOffset(2026, 5, 5, 10, 0, 0, TimeSpan.Zero);
        var currentDate = new DateTimeOffset(2026, 5, 10, 14, 30, 0, TimeSpan.Zero);
